...
export default function GoldTemplate13() {
  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {!opened && (
          <motion.section
            ...
            exit={{ opacity: 0, y: "-100%" }} // 🚀 geser ke atas pas keluar
          ...
          >
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={handleOpen}
                className="bg-[#e1c168] text-white px-6 py-3 rounded-lg font-medium tracking-wide shadow-lg flex items-center gap-2 mx-auto"
              >
      ...
      {/* ===== UNDANGAN LENGKAP ===== */}
      {opened && (
        <div className="relative z-10 pb-24 bg-[url(/images/background.png)] w-full min-h-screen bg-cover">
          <motion.div
            initial={{ x: -500 }} // mulai dari luar layar kiri
            animate={{ x: [-500, window.innerWidth, 0] }} // gerak ke kanan, terus balik ke kiri
            transition={{
              duration: 10, // lama 1 putaran
              ease: "linear", // biar jalannya rata
            }}
            className="absolute z-20 top-32"
          >
            <Image
              src="/asset/car-ice-cream.gif"
              width={400}
              height={400}
              alt="ice"
            />
          ...
          <Image
            ...
            height={250}
            alt="ice"
            className="absolute top-20 -translate-y-1/2 -left-10  w-full"
          />

          <Image
            src="/asset/or-ice.gif"
            width={150}
            height={150}
            alt="ice"
            className="absolute -right-10 top-0 -rotate-12"
          />
      ...
      text-white flex items-center justify-center ${
        switcher ? "hidden" : "opacity-35"
          ...
          <div className="w-full">
            <section className="relative w-full h-screen overflow-hidden bg-[#f9f6f1]">
              {/* Ornamen Bawah (Burung & Bunga) */}
              <div className="absolute bottom-0 left-0 w-full flex justify-between px-6 md:px-12">
                <motion.div
                ...
                >
                  <Image
                    src="/images/ornamen-left.png" // gambar burung kiri
                    alt="Ornamen Kiri"
                    width={300}
                    height={300}
                  />
                ...
                >
                  <Image
                    src="/images/ornamen-right.png" // gambar burung kanan
                    alt="Ornamen Kanan"
                    width={300}
                    height={300}
                  />
              ...
              <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6">
                ...
                <motion.p
                  ...
                  className="text-[#6d2d2d] text-lg md:text-xl font-serif mb-4"
                >
                  The Wedding of
                </motion.p>
                ...
                <motion.div
                  ...
                  transition={{ duration: 1 }}
                  className="relative w-60 h-72 md:w-72 md:h-96 rounded-full overflow-hidden border-4 border-white shadow-lg mb-6"
                >
                  <Image
                ...
                <motion.h1
                  ...
                  className="text-3xl md:text-4xl font-playfair text-[#6d2d2d] mb-2"
                >
                  Habib & Adiba
                </motion.h1>
              ...
              >
                <div className="w-6 h-10 border-2 border-[#6d2d2d] rounded-full flex items-start justify-center p-1">
                  <motion.div
                    animate={{ y: [0, 6, 0] }}
                    transition={{ duration: 1.5, repeat: Infinity }}
                    className="w-2 h-2 bg-[#6d2d2d] rounded-full"
                  />
                </div>
              </motion.div>
            </section>
