...
// ===== Tema Aurora Glow (Template 5) =====
const THEME = {
  pageBg:
    "bg-[radial-gradient(1400px_900px_at_20%_-10%,#e6e6ff,transparent),radial-gradient(1400px_900px_at_100%_0%,#ffe6ff,transparent)] bg-[#f9f9ff]",
  headerGrad: "bg-gradient-to-r from-indigo-800 via-fuchsia-600 to-cyan-500",
  card: "bg-gradient-to-br from-[#faf7ff]/80 via-[#f9f0ff]/70 to-[#f0faff]/80 backdrop-blur-lg",
  border: "border-fuchsia-300",
  textMain: "text-indigo-900",
  cta: "bg-gradient-to-r from-fuchsia-600 via-indigo-600 to-cyan-500 hover:from-fuchsia-500 hover:to-indigo-400",
  chip: "bg-fuchsia-100 text-fuchsia-800",
};

export default function GoldTemplateFive() {
        ...
        <motion.section
          ...
          <motion.div
            ...
            <motion.div
              ...
              className='w-44 h-44 mx-auto rounded-full overflow-hidden border-4 border-cyan-400 mb-5 shadow-xl'>
              <Image
                src='/images/tmp.jpg'
                width={176}
                height={176}
          ...
          <motion.section
            ...
            <div
              ...
              <p className='text-sm text-gray-700 mb-4'>
                Jika berkenan memberikan hadiah, Anda dapat mengirimkan melalui
                e-wallet.
              </p>
          ...
          <motion.section
            ...
            <form
              ...
              <input
                ...
                className='p-3 rounded-lg border focus:outline-none focus:ring-2 focus:ring-fuchsia-400 bg-white'
                required
              />
              <select
                name='kehadiran'
